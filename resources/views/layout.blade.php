...
<head>
  ...
  .btn {
    ...
    /* Styles pour les boutons "Valider" et "Supprimer" */
    .btn-action {
        margin-right: 5px; /* Marge à droite entre les boutons */
    }

    /* Styles spécifiques pour le bouton "Valider" */
    .btn-validate {
    ...
    .btn-delete {
        ...
        border-color: #dc3545; /* Couleur de bordure rouge */
    }
    ...
    <div id="app">
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #B0C9CD;">
            <div class="container">
                ...
                <a href="home" class="btn btn-primary welcome-heading2" style="background-color: #AB792D; color: white; margin-right: 10px;">
...
<a href="contact" class="btn btn-success welcome-heading2" style="background-color: #AB792D; color: white; margin-right: 10px;">
